...
- [x] **标签/话题**（#tag）
- [ ] **举报/屏蔽**（最小审核工具）
- [x] **通知**（被评论/被点赞）.//添加互动功能，别人点赞评论自己，自己需要及时知道，并且可以回复之类的。
- [x] **统计**（DAU、发帖数、评论数、AI 调用次数）
- [ ] **备份与数据迁移脚本**

- [ ] 想法云添加功能 ：显示偏好功能，可以选择仅仅显示自己关注的或者指定某些人，也可以显示感悟/吐槽分类，总之尽可能多点分类，具体如何实现可以先讨论一下；

- [ ] 添加热点功能，最热最新的发表

- [x] ai润色需要返回评论的结果到前端，不要多余的描述，再确认是否发布，也可以撤销ai润色，也可以修改结果再发布

- [x]  点击发布，应该是显示发布中，而不是收集思绪中；

- [ ]  另外，发布思绪之后，应该将思绪添加到云图中（尽可能显眼的地方，刚发布的可以特殊标识一下），而不是刷新页面；点击思绪详情也不该刷新页面。
---
